const ourRoots = {
  imgsrc: '/src/img/main-photo.jpg',
  h1: 'OUR ROOTS',

  firstParagraph: `This is the perfect place for generating visitor interest by going into more detail about yourself,
  ...
  secondParagraph: `Foster's long, scrolling homepage is actually an Index Page, which stacks multiple pages vertically. Under a Foster Index Page,
  ...
  thirdParagraph: `The Foster template supports three separate navigation areas: two in the site header section
  ...
  fourthParagraph: `With any Squarespace template, you can use Spacer Blocks to tailor the layout of your pages.
